            ...
            const ComputePtrOffsetOfBatch compute_ptr_offset_of_batch)
{
    ...
    const long_index_t a_batch_offset =
        amd_wave_read_first_lane(      static_cast<int64_t>(     compute_ptr_offset_of_batch.GetAPtrOffset(g_idx)   )  );
    const long_index_t b_batch_offset =
        amd_wave_read_first_lane(      static_cast<int64_t>(      compute_ptr_offset_of_batch.GetBPtrOffset(g_idx)  )   );
    const long_index_t e_batch_offset =
        amd_wave_read_first_lane(     static_cast<int64_t>(    compute_ptr_offset_of_batch.GetEPtrOffset(g_idx)   )  );
            ...
            const Block2CTileMap block_2_etile_map)
{
    ...
    const long_index_t a_batch_offset =
        amd_wave_read_first_lane(    (int64_t)   compute_ptr_offset_of_batch.GetAPtrOffset(g_idx));
    const long_index_t b_batch_offset =
        amd_wave_read_first_lane(    (int64_t)   compute_ptr_offset_of_batch.GetBPtrOffset(g_idx));
    const long_index_t e_batch_offset =
        amd_wave_read_first_lane(    (int64_t)   compute_ptr_offset_of_batch.GetEPtrOffset(g_idx));
